                ...
                <section class="card border-0 py-1 p-md-2 p-xl-3 p-xxl-4 mb-4">
                    <div class="card-body">
                        <div class="d-flex align-items-center mt-sm-n1 pb-4 mb-0 mb-lg-1 mb-xl-3">
                            <h2 class="h4 mb-0"> <a class="btn btn-secondary me-3 me-sm-4" type="button" href="/goods/index"><i class="ai-undo me-2 ms-n1"></i> Bens</a></h2>
                        </div>
                        <div class="d-flex align-items-center">

                        </div>

                        <form action="goods/update/{{$good->id}}" method="POST" enctype="multipart/form-data">
                            @csrf
                            {{ method_field('PUT') }}
