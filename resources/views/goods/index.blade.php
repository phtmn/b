          ...
          <div class="card border-0 py-1 p-md-2 p-xl-3 p-xxl-4">
            <div class="card-body">
              <div class="d-flex align-items-center mt-sm-n1 pb-4 mb-0 mb-lg-1 mb-xl-3">
                <h2 class="h4 mb-0"> <a class="btn btn-secondary me-3 me-sm-4" type="button" href="/goods/create"><i class="ai-square-plus me-2 ms-n1"></i> Bens</a></h2>
              </div>
              <!-- Stats-->
                    ...
                    <tr>
                      <td class="border-0 py-1 px-0 ">
                        <div class="d-flex align-items-center mt-3">
                          ...
                          <div class="ps-3 ps-sm-4">
                              <h4 class="h6 mb-2"><a href="goods/edit/{{$d->id}}">{{$d->title}}</a></h4>
                      ...
                      <td class="border-0 text-end py-1 pe-0 ps-3 ps-sm-4">
                        <div class="fs-sm text-muted mb-2">
                          <form action="good/destroy'/{{$d->id}}" method="post">
                            {{ csrf_field() }}
                            {{ method_field('DELETE') }}
